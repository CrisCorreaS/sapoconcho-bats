...
void loop()
{
    ...
    for (int i = 1; i <= 4; i = i + 1) // Esta tarea se repetirá 4 veces -> Hacemos un for que va contando de uno en uno en orden ascendente (i = i + 1), empezando por el 1 (i = 1), mientras el número sea menor o igual que 4 (i >= 4) -> for(i = 0; i <= 4; i = i + 1) -> cuenta: 1, 2, 3 y 4; por lo que se repite cuatro veces
    {                                 // La instrucción que se repite es el parpadeo de medio segundo
