...
void loop()
{
    ...
    for (int i = 4; i > 0; i = i - 1) // Esta tarea se repetirá 4 veces -> Hacemos un for que va contando de uno en uno en orden descendente (i = i - 1), empezando por el 4 (i = 4), mientras el número sea mayor que 0 (i > 0) -> for(i = 4; i > 0; i = i - 1) -> cuenta: 4, 3, 2 y 1; por lo que se repite cuatro veces
