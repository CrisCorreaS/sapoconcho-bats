...
void loop()
{
    ...
    for (int i = 0; i < 4; i = i + 1) // Esta tarea se repetirá 4 veces -> Hacemos un for que va contando de uno en uno (i = i + 1), empezando por el 0 (i = 0), mientras el número sea menor que 4 (i < 4) -> for(i = 0; i < 4; i = i + 1) -> cuenta: 0, 1, 2 y 3; por lo que se repite cuatro veces
